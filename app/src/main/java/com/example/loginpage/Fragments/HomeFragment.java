...
import static com.example.loginpage.Activities.MainActivity.contextOfApplication;
...
import com.example.loginpage.RecyclerViewAdapters.MainActivityAlbums_RecyclerViewAdapter;
...
public class HomeFragment extends Fragment {
    private View v;
    private TextView usernameGreetingText;
    ...
    public View onCreateView(
        ...
        usernameGreetingText = view.findViewById(R.id.home_usernameTextView);
        String displayName = "";
        displayName = FirebaseAuth.getInstance().getCurrentUser().getDisplayName();
        String greetingString = usernameGreetingText.getText().toString().replace("{Username}",displayName);
        if(displayName != "")
            usernameGreetingText.setText(greetingString);
        return view;
    }
